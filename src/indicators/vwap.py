...
Extended with:
  - Standard deviation bands (1s, 2s)
  - Anchored VWAP (from any custom start index)
...
class VWAPResult:
    vwap:    pd.Series
    upper_1: pd.Series    # VWAP + 1 std
    lower_1: pd.Series    # VWAP - 1 std
    upper_2: pd.Series    # VWAP + 2 std
    lower_2: pd.Series    # VWAP - 2 std
    signal:  VWAPSignal
    last:    float
